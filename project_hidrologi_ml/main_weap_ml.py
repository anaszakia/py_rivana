...
def create_river_network_map(lon, lat, output_dir='.', buffer_size=10000):
    ...
    try:
        ...
        html_path = os.path.join(output_dir, 'RIVANA_Peta_Aliran_Sungai.html')
        m.save(html_path)
        ...
        try:
            ...
            try:
                ...
                png_path = os.path.join(output_dir, 'RIVANA_Peta_Aliran_Sungai.png')
        ...
        # Simpan metadata
        metadata_path = os.path.join(output_dir, 'RIVANA_Metadata_Peta.json')
...
class ModelValidator:
    ...
    def generate_validation_report(self, output_file='RIVANA_Validation_Report.json', output_dir=None):
